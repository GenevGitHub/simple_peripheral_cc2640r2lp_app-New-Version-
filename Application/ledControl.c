 ...
 * @return  None
 *********************************************************************/
uint8_t ledControl_ErrorDisplay()
{
 ...
 * @return  none
 *********************************************************************/
uint8_t ledControl_getError( void )
{
    return led_error_priority;
}
